...
| [User Guide](User-Guide.md) | operators | Day-to-day use: welcome screen, navigation, status checks, web UIs, device controls, settings. |
...
| [Architecture Overview](Architecture-Overview.md) | devs | Module boundaries, data model, threading, startup flow, UI composition. |
| [Networking & Device Control](Networking-and-Device-Control.md) | devs | Status checks, HTTP/TCP transports, config-driven commands, recorder polling, browser launch. |
